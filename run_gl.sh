...
# do
# 	angsd -GL 2 -out ./gl_chr/gl_chr$i -ref $REF -nThreads 2 -doGlf 2 -doMajorMinor 1 -SNP_pval 1e-6 -doMaf 1 -C 50 -minMapQ 30 -minQ 20 -remove_bads 1 -uniqueOnly 1 -bam $BAM_LIST -r $i &
# done
# 
# wait
