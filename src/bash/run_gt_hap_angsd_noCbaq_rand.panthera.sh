...
# set working folder
WDIR=/home/projects/ku-cbd/data/zanzibar/pop_gen/12-eig_noCbaq_rand
...
HAP_CHR=/home/projects/ku-cbd/data/zanzibar/pop_gen/12-eig_noCbaq_rand/hap_chr
...
IFS=$'\n'
HAP_SUFFIX='.minD1.q20.noCbaq.rand.cons'
...
do
	...
	BAM=$(echo $i | awk '{print $2}')
	 ...
	 # test if file exist
		...
		angsd -nThreads 40 -i $BAM -dofasta 1 -doCounts 1 -minQ 20 -minmapq 20 \
			-setminDepthInd 1 -remove_bads 1 -uniqueOnly 1 \
